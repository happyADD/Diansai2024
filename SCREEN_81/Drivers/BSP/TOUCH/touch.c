...
uint8_t tp_init(void)
{
    ...
    if (lcddev.id == 0X5510 || lcddev.id == 0X4342 || lcddev.id == 0X1018  || lcddev.id == 0X4384 || lcddev.id == 0X9806)   /* gtxx系列电容触摸屏 */
    {
        gt9xxx_init();
    ...
    else if (lcddev.id == 0X1963 || lcddev.id == 0X7084 || lcddev.id == 0X7016)   /* ftxx系列电容触摸屏 */
    {
